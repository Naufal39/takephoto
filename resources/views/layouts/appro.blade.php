...
<head>
    ...
    <title>TakePhoto | {{ Auth::user()->name }}</title>
    ...
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
      ...
      <!-- Favicons -->
    <link href="{{asset('profile/img/favicon.png')}}" rel="icon">
    <link href="{{asset('profile/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
