...
@section('content')
              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-sm-6 col-md-5">
                    <div class="about-img">
                    <img src="{{asset('profile/img/testimonial-2.jpg')}}" class="img-fluid rounded b-shadow-a" alt="">
                    </div>
                  </div>
  ...
  <script src="{{asset('profile/lib/popper/popper.min.js')}}"></script>
  <script src="{{asset('profile/lib/bootstrap/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('profile/lib/easing/easing.min.js')}}"></script>
  <script src="{{asset('profile/lib/counterup/jquery.waypoints.min.js')}}"></script>
  <script src="{{asset('profile/lib/counterup/jquery.counterup.js')}}"></script>
  ...
  <script src="{{asset('profile/lib/typed/typed.min.js')}}"></script>
  <!-- Contact Form JavaScript File -->
  <script src="{{asset('profile/contactform/contactform.js')}}"></script>
